public class Afternoon121520 {
    public static void main(String[] args) {

    }
    //worked off of codingbat challenges for mapping that I
    //have already completed.
    //We're told of new assignment in document form that would be issued
    //to each of us for completion.
}
